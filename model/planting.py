...
class Planting:
    ...
    def read(self, mute=False):
        ...
        try:
            data = ""
            with open(self.plantingfile, "r", encoding="utf-8-sig", errors="replace") as pf:
                data = json.load(pf)

            for planting in data["list_of_planting"]:
                self.list_of_planting.append({"culture": planting.get("culture", ""), "area": planting.get("area", ""), "amount": planting.get("amount", ""), "amount_canonical": planting.get("amount_canonical", planting.get("amount", "")), "date": planting.get("date", "")})
    ...
    def save(self, mute=False):
        ...
        try:
            with open(self.plantingfile, "w", encoding="utf-8") as pf:
    ...
    def new_planting(self, culture, area, amount, date):
        ...
        self.list_of_planting.append({"culture": culture, "area": area, "amount": original_amount, "amount_canonical": canonical_amount, "date": date})
    ...
    def update_planting(self, _id, culture, area, amount, date):
        ...
        self.list_of_planting[_id]["amount"] = original_amount
        self.list_of_planting[_id]["amount_canonical"] = canonical_amount
